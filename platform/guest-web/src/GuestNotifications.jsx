export default function GuestNotifications({ notification, showUpNext, upNextNotice, upcomingSeconds, celebration }) {
  return <>
    ...
    {celebration && <aside className="song-celebration" role="status" aria-live="assertive" style={{ '--celebration-duration': `${celebration.overlayDurationMs}ms` }}><div className="celebration-copy"><span>¡AHORA SUENA TU CANCIÓN!</span><strong>{celebration.title}</strong></div></aside>}
  </>
}
